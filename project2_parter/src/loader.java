...
//        try {
//            properties.load(new InputStreamReader(new FileInputStream("C:\\Users\\ZCR\\Desktop\\dbUser.properties")));
...
//                stmt.setInt(4, subreply.getReplyid());
//                stmt.executeUpdate();
//            } catch (SQLException ex) {
//                throw new RuntimeException(ex);
//            }
...
////读两个json文件，建好了两个list
//        String fileName_posts = "C:\\Users\\ZCR\\Desktop\\posts.json";
...
//        }
//
//        String fileName_replies = "C:\\Users\\ZCR\\Desktop\\replies.json";
